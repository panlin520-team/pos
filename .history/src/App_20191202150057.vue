  ...
  <div id="app">
    ...
    >
     ...
     <el-menu
        ...
        v-if="$route.meta.navbar"
      >
        <template :index="issue.index" v-for="(issue,index) in treelist" :key="issue.index">
          <template v-if="issue.name === $store.state.leftNavState">
            <template v-for="(item,index) in issue.children" :key="memane.index">
