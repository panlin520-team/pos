            ...
            <div class="usermessage">
              <div class="userNamePoto">
                <div class="userName-box">
                  <label>姓名：</label>
                  <el-input v-model="input_name" @input="hqjdinput" placeholder="请输入姓名"></el-input>
        ...
        .then(res => {
          ...
          for (let i = 0; i < arr.length; i++) {
            ...
            for (let j = 0; j < str.length; j++) {
              ...
              str[j].accountType = arr[i].accountType;
              str[j].accountTypeId = arr[i].accountTypeId;
              str[j].amount = arr[i].amount;
              str[j].isQingKe = arr[i].isQingKe;
