            ...
            <div class="usermessage">
              <div class="userNamePoto">
                <div class="userName-box">
                  <label>姓名：</label>
                  <el-input v-model="input_name" v-on:keyup.13.native="show_stgbcar" placeholder="请输入姓名"></el-input>
                ...
                <div class="userName-box">
                  <label>联系电话：</label>
                  <el-input v-model="input_number" v-on:keyup.13.native="show_stgbcar2" placeholder="请输入手机号"></el-input>
                  <div class="userName-boxs">
    ...
    memberbalance() {
      ...
      this.$https
        ...
        .then(res => {
          ...
          var str = this.accounBalance;
          localStorage.setItem("list", JSON.stringify(arr));
          res.data.result.list.forEach(value => {
            if (value.isQingKe == 1) {
              this.accounBalance = arr
