...
.floatBox {
  ...
  .memberBox {
    ...
    .accountBalance {
      ...
      // 滚动条区域的宽度 
      .accountCenter::-webkit-scrollbar {
        width: 4px;
      }
      /* 滚动槽的样式设置 */
      .accountCenter::-webkit-scrollbar-track {
        -webkit-box-shadow: inset 0 0 6px rgba(247, 8, 8, 0.5);
      }
      /* 滚动条滑块的样式设置 */
      .accountCenter::-webkit-scrollbar-thumb {
        background: rgba(0, 0, 0, 0.1);
        -webkit-box-shadow: inset 0 0 6px rgb(252, 53, 4);
      }
      .accountCenter::-webkit-scrollbar-thumb:window-inactive {
