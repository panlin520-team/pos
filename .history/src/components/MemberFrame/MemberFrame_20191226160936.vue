          ...
          <div class="content">
            ...
            >
              ...
              <div class="stgblcktopmain" slot="main">
                ...
                <div>
                  <label>体验卡</label>
                  <el-button size="mini" type="success" @click="experienceCard(scope.row)">查看详情</el-button>
                </div>
                <div>
                  <label>项目定制</label>
                  <el-button size="mini" type="success" @click="experienization(scope.row)">查看详情</el-button>
                </div>
                <PopOver
