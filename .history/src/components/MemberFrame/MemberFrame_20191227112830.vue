...
export default {
  ...
  methods: {
    ...
    rienizatails(res) {
      console.log(res);
      this.productCoderienls = res.productCode;
      this.productNameerienls = res.productName;
      this.rienlsId = res.id;
    ...
    salesReturnails(res) {
      ...
      this.productCodenal2 = res.recordId;
      this.productNamenal2 = res.recordId;
    ...
    pojectCared() {
      ...
      var params = {
        memberNum: this.$store.state.member.userNumber,
        id: this.rienlsId,
        productCode: this.productCoderienls,
        storeId: localStorage.getItem("storeId"),
        storeName: localStorage.getItem("storeName"),
        productName: this.productNameerienls,
        postAndBeautician: "",
