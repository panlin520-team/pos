                  ...
                  <div class="main" slot="main">
                    ...
                    <div class="empSelect">
                      ...
                      <div class="empList scrollY">
                        ...
                        <el-select v-model="value_personal" @change="valub(item)" placeholder="请选择员员工">
                          <el-option
                        ...
                        <el-date-picker v-model="valuexuaTime" type="date" placeholder="选择日期"></el-date-picker>
                        <el-time-select
                          ...
                          placeholder="选择时间"
                        ></el-time-select>
                        <el-select v-model="duration" placeholder="请选择时长" class="setEmpPicker">
                          <el-option
...
export default {
  ...
  methods: {
    ...
    valub(res) {
      console.log(res);
      console.log(this.value_personal);
    },
    // 服务项目工种菜单切换
    switchEmpList(index, curId, empId) {
      ...
      var str = [];
      str.push({
        beauticianName: this.value_personal,
        beauticianId: this.value_personal,
