...
export default {
  ...
  methods: {
    ...
    pushService() {
      ...
      var str = [];
      arr.push({
        productName: this.proNmar,
        productCode: this.personal,
        nursingDate: this.valuexuaTime + "" + this.value_minute,
        duration: this.duration
        // value_minute: this.value_minute
      });
      str.push({
        productName: this.proNmars,
        productCode: this.personals,
        nursingDate: this.valuexuaTimes + "" + this.value_minutes,
        duration: this.duratiot
        // value_minute: this.value_minute
      });
      this.otp = arr.concat(str);
      if (this.value_personal && this.valuexuaTime && this.value_minute && this.duration) {
        
      }else if(this.value_personals && this.valuexuaTimes && this.value_minutes && this.durations){
