              ...
              <div class="stgblcktopmain" slot="main">
                <div class="projcttop">
                  <div class="projectcar">
                    <el-button size="mini" type="success" @click="experienceCard"></el-button>
                  </div>
                  <div class="projectcars">
                    <el-button size="mini" type="success" @click="experienization">项目定制</el-button>
                  </div>
                </div>
                <div class="projctbottom" v-if="experiencehaha"></div>
                <div class="projctbottom" v-if="experienceheihei">嘿嘿嘿</div>
                <!-- 定制项目划卡 -->
                <PopOver
