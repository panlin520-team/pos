          ...
          <div class="recharge_main" slot="main">
            <el-form ref="form" :model="form" status-icon label-width="80px">
              ...
              <el-form-item label="员工" prop="employee">
                <el-select v-model="value_tpeple" @change="changepeople" placeholder="请选择">
                  <el-option
...
export default {
  ...
  methods: {
    //获取员工
    changepeople() {
      console.log(this.value_tpeple);
      this.beauticianIds[0].beauticianId = this.
    },
    //数据图表最近10笔消费
    initCharts() {
    ...
    rechargeList() {
      ...
      var params = {
        ...
        beauticianId: [{ beauticianId: this.value_tpeple }],
