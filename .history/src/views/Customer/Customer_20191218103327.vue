        ...
        <div v-show="num==5" class="dataAnalysis">
          ...
          <el-tabs v-model="activeAnalysis" @tab-click="handleAnalysis">
            <el-tab-pane label="最近10笔消费" name="first">
              <div style="width:800px;height:600px;margin-left:200px;" id="main">哈哈</div>
            </el-tab-pane>
            <el-tab-pane label="最近10笔充值" name="second">
              <div style="width:800px;height:600px;margin-left:200px;" id="main_recharge">哈哈</div>
            </el-tab-pane>
            <el-tab-pane label="项目消费次数Top10" name="third">
              <div style="width:800px;height:600px;margin-left:200px;" id="main_consumption">哈哈</div>
            </el-tab-pane>
  ...
  methods: {
    ...
    savingsData() {
      ...
      this.$https.fetchPost(url, params).then(
        res => {
          if (res.data.result) {
            this.dataTotal_savings = res.data.result.length;
