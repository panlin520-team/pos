      ...
      <div class="main" slot="main">
        <div class="items scrollY" style="height:400px;">
          ...
          <div class="item">
            ...
            <div class="value">
              <el-select v-model="part_timdepartment" placeholder="请选择兼职职务">
                <el-option
          ...
          <div class="item">
            ...
            <div class="value">
              <el-select v-model="part_timeposition" placeholder="请选择兼职职务">
                <el-option
          ...
          <div class="item">
            ...
            <div class="value">
              <el-select v-model="part_timeJobe" @b="changejobe" placeholder="请选择兼职职务">
                <el-option
