    ...
    >
      ...
      <div class="stgblcktopmain" slot="main">
        <div class="newcenters">
          <label>姓名</label>
          <div>{{this.cordename}}</div>
        </div>
        <div class="newcenters">
          <label>员工编号</label>
          <div>{{this.newdatasalary.name}}</div>
        </div>
        <div class="newcenters">
          <label>开始时间</label>
          <div>{{this.newdatasalary.statisticDateStart}}</div>
        </div>
        <div class="newcenters">
          <label>结束时间</label>
          <div>{{this.newdatasalary.statisticDateEnd}}</div>
        </div>
        <div class="newcenters">
          <label>个数业绩</label>
          <div>{{this.newdatasalary.onjed}}</div>
        </div>
        <div class="newcenters">
          <label>金额业绩</label>
          <div>{{this.newdatasalary.onjed}}</div>
...
export default {
  ...
  methods: {
    ...
    salaryname(res) {
      ...
      this.cordename = res.staffNumber;
