    ...
    <div class="carlistnerve">
      <div class="carHeader">
        ...
        <div class="herderInput">
          <label>会员姓名：</label>
          <el-input v-model="input_vipname" v-on:keyup.13.native="seekvainame" @blur="seekvainame" clearable placeholder="请输入会员姓名"></el-input>
         
        </div>
        <div class="herderInput">
          <label>手机号：</label>
          <el-input v-model="input_penober" v-on:keyup.13.native="seeknumber" @blur="seeknumber" clearable placeholder="请输入手机号"></el-input>
