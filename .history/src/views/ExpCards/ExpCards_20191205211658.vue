...
<template>
  <div class="expcardPage">
    <div class="ordersearch">
      <label>体验卡名称：</label>
      <el-input v-model="input_experience" placeholder="请输入要查询的商品"></el-input>
    ...
    >
      ...
      <div class="stgblcktopmain" slot="main">
        ...
        <div class="particularsCar">
          ...
          <label>水单号：</label>
          <el-input type="number" v-model="woterMemo" clearable placeholder="请输入水单号"></el-input>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    //点击卡片查看详情
    car_smreos(res) {
      (this.woterMemo = ""), (this.input_money = "");
      this.value_payment = "";
