      ...
      <el-table :data="storageList">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button size="mini" type="warning" @click="showsoldOut(scope.row)">下架</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="block">
    ...
    extractchans() {
      if (this.multipleSelection.length !== 0) {
        this.multipleSelection.forEach(value => {
          this.multiplelist.forEach(value2 => {
            console.log(value2);
this.multiplelist.push(value.productCode);
            // if (value.productCode !== value2) {
            //   this.multiplelist.push(value.productCode);
            // }
          });
        });
