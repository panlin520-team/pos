          ...
          >
            ...
            <div class="stgblcktopmain" slot="main">
              <el-form :model="addruleForm" :rules="rules" ref="addruleForm" label-width="100px">
                ...
                <el-form-item class="Trueincreased">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        projectName: [
          { required: true, message: "请选择can'pin", trigger: "blur" }
        ],
        addrepertory: [
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          if (this.seekListFilter.length > 0 && this.addruleForm.name) {
            if (this.merchantListFilter.length > 0 && this.addruleForm.addrepertory !== "") {
