...
export default {
  ...
  methods: {
    ...
    onProvincesChange() {
      ...
      if (accoers.supplierId) {
        this.supplierCategoryName = 2;
      } else {
        this.supplierCategoryName = 1;
      }
      console.log(accoers);
    },
