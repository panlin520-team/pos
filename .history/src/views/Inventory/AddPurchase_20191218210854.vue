        ...
        <el-table-column label="操作" min-width="280">
          <template slot-scope="scope">
            <div class="InventryOperation">
              <div class="inventsome1">查看</div>
              <div class="inventsome2" :class="classObject">作废</div>
              <div class="inventsome3">确认收货</div>
            </div>
            ...
            <el-button size="mini" type="success" @click="confirmPopOver(scope.row)">确认收货</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 查看订单弹出框 -->
...
export default {
  ...
  data() {
    return {
      ...
      //动态样式
      classObject: { actives: true, sort: false },
      //添加采购列表
      storageList: [],
      //入库菜单
      storageMenus: [
