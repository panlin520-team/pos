      ...
      <div class="wareBottom">
        <div class="wareBright">
          ...
          <div class="salesmansex">
            <el-select v-model="valuesalesman" @change="changevasles" placeholder="请选择销售员">
              <el-option
...
export default {
  ...
  methods: {
    ...
    //销售员
    changevasles(){
if (!this.supplierCategoryName) {
  this.$message({
              message: "请先选择gong'yin's",
              type: "warning"
            });
}
    },
    ...
    submitindent() {
      ...
      var params = {
        ...
        staffNumber: this.valuesalesman,
