...
export default {
  ...
  data() {
    return {
      ...
      tableData_enterpurchase: [
        {
          createOperator: "刘德华",
          inStorageNumber: "2135423452",
          inStorageDate: "2019-11-05 15:02:41"
        },
        {
          createOperator: "刘德华",
          inStorageNumber: "2135423452",
      ...
      tableexamine: [
        {
          itemname: "可爱多可爱多可爱多可爱多爱多多",
          itemnum: "123",
          itemunit: "456件",
          itemday: "2019-11-05 15:02:41"
        },
        {
          itemname: "可爱多可爱多可爱多可爱多爱多多",
          itemnum: "123",
  ...
  methods: {
    ...
    showPopOver(item) {
      ...
      this.tableexamine = item.inStorageProductLists;
