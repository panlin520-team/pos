    ...
    <div class="merchantList">
      <el-table :data="storageList">
        ...
        <el-table-column label="数量">
          <template slot-scope="scope">
            <div slot="reference" class="name-wrapper">{{ scope.row.storeNumbers }}</div>
          </template>
        </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope" v-if="scope.row.productSubordinate == 0">
      ...
      <div class="block">
        ...
        >
          ...
          <div class="stgblcktopmain" slot="main">
            ...
            <!-- 出库总数 -->
            <div class="projctbottom" v-show="experiennumber">
            ...
            <!-- 护肤产品 -->
            <div class="projctbottom" v-show="dasdfcnnumber">
            ...
            <div class="projctbottom" v-show="experiencsert">
          ...
          if (res.data.result !== null) {
            ...
            if (this.value_project == 1) {
              resList.forEach(value => {
                if (value.productSubordinate == 1) {
                  value.storeNumbers = value.stockQuantity;
                } else {
                  value.storeNumbers = value.stockNum;
                }
              });
              this.storageList = resList;
            } else {
              resList.forEach(value => {
                if (!value.productSubordinate) {
                  value.productSubordinate = value.stockQuantity;
                } else {
                  value.storeNumbers = value.stockNum;
                }
              });
