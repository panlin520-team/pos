                  ...
                  res => {
                    if (res.data.responseStatusType.message == "Success") {
                      ...
                      for (let i = 0; i < arr.length; i++) {
                        const element = arr[i];
                        // let str = (JSON.stringify(arr[i])).toString();
                        console.log('1',"<p>" + JSON.stringify(arr[i]) + "<p></br>");
                        console.log('3',"<p>" + eval(arr[i]) + "<p></br>");
                        console.log('8',"<p>" + eval(JSON.stringify(arr[i])) + "<p></br>");
                        str += "<p>" + JSON.stringify(arr[i]) + "<p></br>";
                      }
                      console.log(str);
