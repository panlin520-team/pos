...
<template>
  <div class="PerformanceQuery">
    <div class="titlebtn">
      <el-button type="success">切换为金额业绩统计方式</el-button>
      <el-button @click="size" type="success">切换为个数业绩统计方式</el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    initCsizedata() {
      var url =
        this.$https.dataHost + "/performance/selectLadderDetailedListColumnarForNumber";
      var params = {
        storeId: localStorage.getItem("storeId")
      };
      this.$https
