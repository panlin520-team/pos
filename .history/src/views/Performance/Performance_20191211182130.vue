...
<template>
  <div class="PerformanceQuery">
    ...
    <div class="naver" v-if="visible_merchande == false">
      <div class="Employees" id="main_recharge"></div>
      <div class="Employs" id="main_rechargess"></div>
    </div>
    <div class="navers" v-if="visible_merchandes == false">
      <!-- <div class="Employees" id="main_recharges"></div>
      <div class="Employs" id="main_rechargesss"></div>-->
    </div>
...
export default {
  ...
  methods: {
    ...
    initCharts3() {
      var myChart = this.$echarts.init(
        document.getElementById("main_recharges")
      );
      // 绘制图表
      let option = {
        title: {
    ...
    initCharts4() {
      var myChart = this.$echarts.init(
        document.getElementById("main_rechargesss")
      );
      // 绘制图表
      let option = {
        title: {
