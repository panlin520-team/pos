...
export default {
  ...
  methods: {
    ...
    commonleClick(tab) {
      ...
      console.log(this.productbleTabs);

      // console.log(this.productbleTabs);
      // if (event.target.getAttribute("id") == "tab-洗剪吹") {
      //   this.subclassID = 1;
      //   this.subclassName = "洗吹";
      //   this.typep = 1;
      // } else if (event.target.getAttribute("id") == "tab-实体商品") {
      //   this.subclassID = 2;
        ...
        .then(res => {
          ...
          if (res.data.result) {
            ...
            for (let i = 0; i < arr.length; i++) {
              console.log(arr[i]);
              let str = this.productbleTabs;
              for (let j = 0; j < str.length; j++) {
                str[j].subclassID2 = arr[i].subclassID + "";
                str[j].subclassName2 = arr[i].subclassName + "";
                console.log("222", str[j]);
              }
            }
            console.log("6666", this.productbleTabs);
