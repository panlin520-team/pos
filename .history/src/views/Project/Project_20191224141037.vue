  ...
  data() {
    return {
      ...
      editableTabs: [
        {
          commodityTypeID: 1,
          commodityTypeName: "产品"
        }
      ],
      productbleTabs: [
        {
          subclassName: "xi'jian"
        }
      ],
      //项目单个数据
      productmodel: [],
  ...
  methods: {
    ...
    car_smreos(res) {
      ...
      if (this.stockNum !== 0) {
        ...
        // });
        // var resss = this.tableDataList.indexOf(res.productCode);
        // console.log(resss);
        // if (resss == -1) {
        //   this.prodtCdList.push(res.productCode);
        //   this.tableDataList.push(res);
        //   console.log(this.prodtCdList);
