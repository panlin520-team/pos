...
export default {
  ...
  methods: {
    ...
    changeNumes(res) {
      console.log(res);
      res.retailPrice = res.originalPrice / res.discount;
      console.log(res.res.discount);
      
      console.log(res.originalPrice / res.discount);
    ...
    changeRefer(res) {
      ...
      res.discount = res.originalPrice / res.retailPrice;
