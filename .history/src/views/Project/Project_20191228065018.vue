      ...
      <div class="stgblcktopmain" slot="main">
        ...
        <div>
          <div class="catalysis">
            <div>
              <label>支付方式：</label>
              <el-select v-model="input_cataly" @change="changeOpen(item)" placeholder="请选择">
                <el-option
  ...
  methods: {
    ...
    car_smreos(res) {
      ...
      var object = {
        ...
        originalPrice: this.retailPrespoe,
    ...
    changeOpen(res) {
      ...
      this.payTypeCategory = res.payTypeCategory;
      this.accountType = res.accountType;
      this.payTypeName = res.payTypeName;
      if (res.discount == 0) {
    ...
    changeNumer(res) {
      ...
      console.log(res);
      res.originalPrice = res.amount * res.retailPrice;
      if (res.amount < 1) {
        res.amount = 1;
      }
      console.log(res);
    ...
    changeNumes(res) {
      console.log(res);
      res.retailPrice = res.originalPrice / res.amount;
      this.calcTotalPrice();
    },
    //改变单价
    changeRefer(res) {
