  ...
  <div class="settingPage fluid">
    ...
    <div class="outerbox">
      ...
      <div class="centercent">
        ...
        <!-- 地图 -->
        <div class="shopsmap">
          <div id="container" class="coordinates">地图坐标</div>
...
<script type="text/javascript" src="http://webapi.amap.com/maps?v=1.3&key=3a0220bd39558a75550c3b0e48727ef8"></script>
<script>
export default {
  name: "XXX",
  components: {},
