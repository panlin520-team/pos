<!-- 店铺设置 -->
<script type="text/javascript" src="https://webapi.amap.com/maps?v=1.4.15&key=3a0220bd39558a75550c3b0e48727ef8"></script>
<template>
...
export default {
  ...
  data() {
    return {
      ...
      storeAddress: "成都高新区",
      // 门店电话
      storePhone: "11234234242",
      // 门店营业时间
      storeBusinessTime: "9.00-10.00",
      // 行业数据
      storeIndustrys: [],
      // 行业id
      storeIndustryId: "",
      // 行业值对应文本
      storeIndustryText: "美容美发",
      // 开始时间
      startTime: "",
      // 结束时间
      endTime: "",
...
————————————————
版权声明：本文为CSDN博主「kk_9955」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/qq_40963664/article/details/82743912
